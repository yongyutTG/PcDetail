            ...
            <div class="row g-4">
                <div class="col-md-12">
                    <div class="card shadow-sm">
                        <div class="card-body">
                            <div class="d-flex align-items-center gap-2 mb-3">
                                ...
                                <button type="button" class="btn btn-add ms-auto" data-bs-toggle="modal"
                                    data-bs-target="#registerModal" style="min-width: 120px;">
                        ...
                        <div class="modal fade" id="registerModal" tabindex="-1" aria-labelledby="addPcLabel"
                            aria-hidden="true">
                            <div class="modal-dialog modal-dialog-scrollable modal-lg">
                                <div class="modal-content">
                                    <form id="registerForm">
                                        <!-- ✅ เปลี่ยนเป็น registerForm -->
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <input type="hidden" name="UPDATED_USERID"
                                                value="<?= session()->get('USER_ID') ?? 1 ?>">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="submit" id="registerBtn" class="btn btn-save">
                                                <!-- ✅ ใส่ id -->
