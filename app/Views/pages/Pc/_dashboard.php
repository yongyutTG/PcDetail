      ...
      <div class="row g-4 mb-4">
        <div class="col-md-3">
          <div class="card text-center shadow-sm border-0">
            <div class="card-body">
              <i class="fa-solid fa-desktop fa-2x text-primary mb-2"></i>
        ...
        <div class="col-md-6">
          <div class="card shadow-sm">
            <div class="card-body">
              ...
              <canvas id="pcLocationChart" height="180"></canvas>
            </div>
          </div>
        </div>
        <div class="col-md-6">
          <div class="card shadow-sm">
            <div class="card-body">
              ...
              <canvas id="pcBranchChart" height="180"></canvas>
            </div>
          </div>
        </div>
      </div>
