            ...
            <div class="row g-4">
                <div class="col-md-12">
                    <div class="card shadow-sm">
                        <div class="card-body">
                            <div class="d-flex align-items-center gap-2 mb-3">
                                <input type="text" id="keywordSearch" class="form-control" style="width:400px;"
                                    placeholder="ค้นหา...">
                                <br>
                  ...
                  <option value="SERVER">Server</option> -->
                                ...
                                <button type="button" class="btn btn-add ms-auto" data-bs-toggle="modal"
                            ...
                            <div class="table-container">
                                ...
                                <div id="loading-spinner" class="text-center my-4">
                                    <i class="fa-solid fa-spinner fa-spin"
                                        style="font-size: 60px; color:rgb(54, 30, 94);"></i>
                                    <p>กำลังโหลดข้อมูล...</p>
                                </div>
                        ...
                        <div class="modal fade" id="pcDetailModal" tabindex="-1" aria-labelledby="pcDetailLabel"
                            aria-hidden="true">
                            <div class="modal-dialog modal-dialog-scrollable modal-lg">
                                <div class="modal-content">
                                    <div class="modal-header custom-header">
                                        <h5 class="modal-title" id="pcDetailLabel">View PC Detail</h5>
                                        <button id="pingBtn" class="btn btn-outline-light btn-sm ms-3"><i
                        ...
                        <!-- Modal แก้ไขข้อมูล -->
                        <div class="modal fade" id="editPcModal" tabindex="-1" aria-labelledby="editPcLabel"
                            aria-hidden="true">
                            <div class="modal-dialog modal-dialog-scrollable modal-lg">
                                <div class="modal-content">
                                    <div class="modal-header custom-header">
                                    ...
                                    <div class="modal-body">
                                        <form id="editPcForm">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="edit_computer_name"
                                                    name="computer_name">
                                            </div>
                                            <div class="mb-3">
                                                <label for="edit_login_user" class="form-label">loginUser</label>
                                                <input type="text" class="form-control" id="edit_login_user"
                                                    name="login_user">
                                            </div>
                                            <div class="mb-3">
                                                <label for="edit_terminal_server"
                                                    class="form-label">TerminalServer</label>
                                                <select class="form-select" id="edit_terminal_server"
                                            ...
                                            <div class="mb-3">
                                                <label for="edit_terminal_login"
                                                    class="form-label">TerminalLogin</label>
                                                <input type="text" class="form-control" id="edit_terminal_login"
                                                    name="terminal_login">
                                            </div>
                                            <div class="mb-3">
                                                <label for="edit_location" class="form-label">Location</label>
                                                <input class="form-control" list="locations" id="edit_location"
                                                    name="location" required placeholder="เลือกหรือพิมพ์ฝ่าย/ส่วนงาน">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="edit_harddisk"
                                                    name="harddisk">
                                            </div>
                                            <div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="edit_solfware"
                                                    name="solfware">
                                            </div>
                                            <div class="mb-3">
                                                <label for="edit_printer" class="form-label">Printer</label>
                                                <input type="text" class="form-control" id="edit_printer"
                                                    name="printer">
                                            </div>
                                            <div class="mb-3">
                                                <label for="edit_printer_share_name"
                                                    class="form-label">PrinterShareName</label>
                                                <input type="text" class="form-control" id="edit_printer_share_name"
                                                    name="printer_share_name">
                                            </div>
                                            <div class="mb-3">
                                                <label for="edit_outlet_port" class="form-label">OutletPort</label>
                                                <input type="text" class="form-control" id="edit_outlet_port"
                                                    name="outlet_port">
                                            </div>
                                            <div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="edit_serial_no"
                                                    name="serial_no">
                                            </div>
                                            <div class="mb-3">
                                                <label for="edit_buy_date" class="form-label">BuyDate</label>
                                                <input type="datetime-local" class="form-control" id="edit_buy_date"
                                                    name="buy_date">
                                            </div>

                                            <div class="mb-3">
                                                <label for="edit_property_code" class="form-label">PropertyCode</label>
                                                <input type="text" class="form-control" id="edit_property_code"
                                                    name="property_code">
                                            </div>
                                            <div class="mb-3">
                                                <label for="edit_property_type" class="form-label">PropertyType</label>
                                                <select class="form-select" id="edit_property_type" name="property_type"
                                                    required>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="edit_monitor"
                                                    name="monitor">
                                            </div>
                                        </form>
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-cancel"
                                            data-bs-dismiss="modal">ปิด</button>
                                        <button type="submit" id="save_editPc" class="btn btn-save"
                                            form="editPcForm">บันทึกข้อมูล</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <!-- Modal เพิ่มข้อมูล -->
                        <div class="modal fade" id="addPcModal" tabindex="-1" aria-labelledby="addPcLabel"
                            aria-hidden="true">
                            <div class="modal-dialog modal-dialog-scrollable modal-lg">
                                <div class="modal-content">
                                    <div class="modal-header custom-header">
                                    ...
                                    <div class="modal-body">
                                        <form id="addPcForm">
                                            <div class="mb-3">
                                                ...
                                                <input type="number" class="form-control" id="add_pc_id" name="pc_id"
                                                    value="<?= esc($newPcId) ?>" readonly>
                                            </div>
                                            <div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="add_computer_name"
                                            ...
                                            <div class="mb-3">
                                                <label for="add_terminal_server"
                                                    class="form-label">TerminalServer</label>
                                                <select class="form-select" id="add_terminal_server"
                                                    name="terminal_server" required style="font-size: 14px;">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="add_terminal_login"
                                                    name="terminal_login">
                                            </div>
                                            <div class="mb-3">
                                                <label for="add_location" class="form-label">ฝ่าย/ส่วนงาน</label>
                                                <input class="form-control" list="Addlocations" id="add_location"
                                                    name="location" required placeholder="เลือกหรือพิมพ์ฝ่าย/ส่วนงาน">
                        ...
                        <input type="text" class="form-control" id="add_ip_address" name="ip_address" required>
                                            ...
                                            <div class="mb-3">
                                                <label for="edit_ip_address" class="form-label">IPAddress</label>
                                                <div class="input-group">
                                                    <input type="text" class="form-control" id="add_ip_address"
                                                        name="ip_address" required>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="add_harddisk"
                                                    name="harddisk">
                                            </div>
                                            <div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="add_solfware"
                                                    name="solfware">
                                            </div>
                                            <div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                                <label for="add_printer_share_name"
                                                    class="form-label">PrinterShareName</label>
                                                <input type="text" class="form-control" id="add_printer_share_name"
                                                    name="printer_share_name">
                                            </div>
                                            <div class="mb-3">
                                                <label for="add_outlet_port" class="form-label">OutletPort</label>
                                                <input type="text" class="form-control" id="add_outlet_port"
                                                    name="outlet_port">
                                            </div>
                                            <div class="mb-3">
                                                <label for="add_use_status" class="form-label">UseStatus</label>
                                                <select class="form-select" id="add_use_status" name="use_status"
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select" id="add_br_no" name="br_no" required
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="date" class="form-control" id="add_buy_date"
                                                    name="buy_date" onkeydown="return false;">
                                            </div>
                                            <div class="mb-3">
                                                <label for="add_property_code" class="form-label">PropertyCode</label>
                                                <input type="text" class="form-control" id="add_property_code"
                                                    name="property_code">
                                            </div>
                                            <div class="mb-3">
                                                <label for="add_property_type" class="form-label">PropertyType</label>
                                                <select class="form-select" id="add_property_type" name="property_type"
                                                    required style="font-size: 14px;">
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-reset_addPc"
                                            id="reset_addPc">ล้างข้อมูล</button>
                                        <button type="button" id=reset_addPc class="btn btn-cancel"
                                            data-bs-dismiss="modal">ปิด</button>
...
document.addEventListener("DOMContentLoaded", function() {
        ...
        try {
            ...
            if (result.status === 'success') {
                if (result.data && result.data.length > 0) {
                    ...
                    tbody.innerHTML =
                        `<tr><td colspan="14" class="text-center text-danger">ไม่พบข้อมูล</td></tr>`;
                    currentPage = 1;
                    totalPages = 0;
                    totalRows = 0;
                }
                ...
                tbody.innerHTML =
                    `<tr><td colspan="14" class="text-center text-danger">เกิดข้อผิดพลาด</td></tr>`;
            }
        } catch (err) {
            spinner.style.display = "none";
   ...
   `;
    ...
    const isModalOpen = () => !!document.querySelector(".modal.show") || document.body.classList.contains(
        "modal-open");
    ...
    document.querySelectorAll('.modal').forEach(modal => {
        modal.addEventListener('hidden.bs.modal', function() {
            document.querySelectorAll('.view-btn:disabled').forEach(btn => {
                btn.disabled = false;
            });
        });
    });
    ...
    tbody.addEventListener("click", async function(event) {
        ...
        if (editBtn) {
            try {
                const res = await apiFetch(`${apiBaseUrl}/${editBtn.getAttribute("data-id")}`, {
                    method: 'GET',
                });
    ...
    async function loadPCHistory(pcId) {
        try {
            const historyRes = await apiFetch(`${historyUrl}/${pcId}`, {
                method: 'GET',
            });
    ...
    async function fetchPCDetail(pcId) {
        try {
            ...
            if (result.status === 'success') {
                ...
                document.getElementById("pcDetailBody").innerHTML = renderDetailHTML(pc);
                ...
                const detailModal = new bootstrap.Modal(document.getElementById("pcDetailModal"));
                detailModal.show();
                ...
                tbody.innerHTML =
                    `<tr><td colspan="4" class="text-center text-danger">ไม่พบข้อมูล</td></tr>`;
            }
        } catch (err) {
            toastr.error(err.message || 'เกิดข้อผิดพลาดในการโหลดข้อมูล', 'Error');
        }
    ...
    function renderPCHistory(history) {
        ...
        if (!history || history.length === 0) {
            historyTableBody.innerHTML =
                '<tr><td colspan="5" class="text-center">ไม่มีประวัติการใช้งาน</td></tr>';
            return;
        }
    ...
    function renderDetailHTML(pc) {
        ...
        return `
      <ul class="list-group">
        <li class="list-group-item"><strong>PcID:</strong> ${pc.pc_id}</li>
    ...
    document.getElementById('addPcForm').addEventListener('submit', async function(e) {
        ...
        try {
            const response = await apiFetch(`${apiBaseUrl}/create`, {
                method: 'POST',
                body: JSON.stringify(data)
            });
    ...
    document.getElementById('btnPing').addEventListener('click', function() {
        ...
        btnPing.innerHTML =
            '<span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span> กำลัง Ping...';
